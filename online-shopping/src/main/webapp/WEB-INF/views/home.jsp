                    ...
                    <div id="carousel-example-generic" class="carousel slide"
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                <img class="slide-image" src="${contextRoot }/static/images/banner01.jpg"
                                     alt="">
                            </div>
                            <div class="item">
                                <img class="slide-image" src="${contextRoot }/static/images/banner02.jpg"
                                     alt="">
                            </div>
                            <div class="item">
                                <img class="slide-image" src="${contextRoot }/static/images/banner03.jpg"
                                     alt="">
                            </div>
                            <div class="item">
                                <img class="slide-image" src="${contextRoot }/static/images/banner04.jpg"
                                     alt="">
                            </div>
                        </div>
